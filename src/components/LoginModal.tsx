...
const LoginModal: FC<LoginModalProps> = ({showLoginModal, setAuth}) => {
  const [user, setUser] = useState({email:"", password:""});

  function onChangeHandler(e?: { target: { value?: any; name?: any }; } | undefined) {
      ...
      <div className="modal-wrapper" onClick={e => {e.stopPropagation()}}>
        ...
        <form action="" className="form">
          ...
          <div className="form-button-group">
            <button className="form-button" type="submit" onClick={() => onClickHandler()}>
            ...
            <button className="form-button button-outline" type="button" onClick={() => {showLoginModal!(false)}}>
              <span>Cancel</span>
            </button>
          </div>
        </form>
